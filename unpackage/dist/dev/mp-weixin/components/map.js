...
var canvaMap = null;var _default =
{
  ...
  data: function data() {
    return {
      ...
      dataed: [
      { bgColor: 'bg-red', title: '累计确诊病例', num: 83293, num_sub: 56 },
      { bgColor: 'bg-yellow', title: '累计疑似人数', num: 754966, num_sub: 257 },
      { bgColor: 'bg-grey', title: '累计死亡人数', num: 4634, num_sub: 33 },
      { bgColor: 'bg-green', title: '累计治愈人数', num: 78394, num_sub: 2 }],
